...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x4bd6; // addresses start with "CRN"
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(3000000000000000); // 30,000,000 coins
...
const char     CRYPTONOTE_NAME[]                             = "crypton";
...
const int      RPC_DEFAULT_PORT                              =  33001;
